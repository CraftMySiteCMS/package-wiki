                                        ...
                                        foreach ($undefinedArticles as $undefinedArticle):?>
                                            <li><?= $undefinedArticle['title'] ?>
                                                <div class="float-right">
                                                    <a href="define/article/<?= $undefinedArticle['id'] ?>" class="icon-add"><i class="fas fa-plus-circle"></i></a>
                                                    <a href="delete/article/<?= $undefinedArticle['id'] ?>" class="icon-delete"><i class="fas fa-trash-alt"></i></a>
                                                </div>
                                            </li>
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        foreach ($undefinedCategories as $undefinedCategorie):?>
                                            <li><?= $undefinedCategorie['name'] ?>
                                                <div class="float-right">
                                                    <a href="define/categorie/<?= $undefinedCategorie['id'] ?>" class="icon-add"><i class="fas fa-plus-circle"></i></a>
                                                    <a href="delete/categorie/<?= $undefinedCategorie['id'] ?>" class="icon-delete"><i class="fas fa-trash-alt"></i></a>
                                                </div>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                    ...
                    <div class="card-body">
                        <ol class="list-unstyled">
                            ...
                            <div class="categorie-container mt-4" id="categorie-<?= $category['id'] ?>">
                                ...
                                <a href="delete/categorie/<?= $category['id'] ?>" class="float-right wiki-icons mr-2"><i class="fas fa-trash-alt"></i></a>
                                <a href="edit/categorie/<?= $category['id'] ?>" class="float-right wiki-icons mr-3"><i class="fas fa-edit"></i></a>
                            </div>
                                <?php $getArticles =  $articles->getAllArticlesInCategory($category['id']);
                                    foreach ($getArticles as $article):?>
                                        <div class="ml-5 mt-1 article-container" id="article-<?= $article['id'] ?>">
                                            ...
                                            <a href="delete/article/<?= $article['id'] ?>" class="float-right wiki-icons mr-2"><i class="fas fa-trash-alt"></i></a>
                                            <a href="edit/article/<?= $article['id'] ?>" class="float-right wiki-icons mr-3"><i class="fas fa-edit"></i></a>
                                        </div>
                                    <?php endforeach; ?>
                            <?php endforeach; ?>
