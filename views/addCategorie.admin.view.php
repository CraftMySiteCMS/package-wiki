                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="<?=WIKI_DASHBOARD_ADD_CATEGORIE_NAME_PLACEHOLDER?>" required>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="description" class="form-control" placeholder="<?=WIKI_DASHBOARD_ADD_CATEGORIE_DESCRIPTION_PLACEHOLDER?>" required>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><?= "https://" . $_SERVER['SERVER_NAME'] . '/wiki/' ?></span>
                                </div>
                                <input type="text" name="slug" class="form-control" placeholder="<?=WIKI_DASHBOARD_ADD_CATEGORIE_SLUG_PLACEHOLDER?>" required>
                            </div>
